...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220420_6374731579b05d125358_20220420105322_archive.zip';
	const ARCHIVE_SIZE		 = '44507550';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6374731-20105322';
    const SECONDARY_PACKAGE_HASH = '90c917e-20105322';
	const VERSION			 = '1.4.5';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.4.5==');
		self::log('----------------------------------------------------');
