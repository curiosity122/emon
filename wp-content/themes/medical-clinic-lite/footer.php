        ...
        <p class="mb-0 py-3 text-center text-md-left">
          ...
          <?php
            if (!get_theme_mod('medical_clinic_lite_footer_text') ) { ?>
              <a href="<?php echo esc_url(__('https://www.misbahwp.com/themes/free-medical-wordpress-theme/', 'medical-clinic-lite' )); ?>" target="_blank">
          ...
          ?>
          <?php if ( get_theme_mod('medical_clinic_lite_copyright_enable', true) == true ) : ?>
            <?php 
            /* translators: %s: Misbah WP */ 
            printf( esc_html__( 'by %s', 'medical-clinic-lite' ), 'Misbah WP' ); ?>
            <a href="<?php echo esc_url(__('https://wordpress.org', 'medical-clinic-lite' )); ?>" rel="generator"><?php  /* translators: %s: WordPress */  printf( esc_html__( ' | Proudly powered by %s', 'medical-clinic-lite' ), 'WordPress' ); ?></a>
          <?php endif; ?>
        </p>
      </div>
    </div>
