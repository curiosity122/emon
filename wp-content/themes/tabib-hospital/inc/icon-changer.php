...
class Tabib_Hospital_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="selected-icon">
                    ...
                    <span>Icon Changer<i class="fa fa-angle-down"></i></span>
                </div>
                ...
                <ul class="icon-list clearfix">
                    ...
                    <?php
                    $tabib_hospital_icon_changer_array = tabib_hospital_icon_changer_array();
                    foreach ($tabib_hospital_icon_changer_array as $tabib_hospital_icon_changer) {
                            $icon_class = $this->value() == $tabib_hospital_icon_changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($tabib_hospital_icon_changer).'"></i>
                            <span class="tabib-hospital-social-class">'.esc_attr($tabib_hospital_icon_changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function tabib_hospital_icon_customize_js() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'tabib-hospital-customize-icon', esc_url(get_template_directory_uri()).'/assets/js/customize-icon.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'tabib_hospital_icon_customize_js' );

if(!function_exists('tabib_hospital_icon_changer_array')){
    function tabib_hospital_icon_changer_array(){
        return array("", 
        "fab fa-500px",
