	 		...
	 		<?php if( get_theme_mod( 'tabib_hospital_date_hide',true) != '' || get_theme_mod( 'tabib_hospital_comment_hide',true) != '' || get_theme_mod( 'tabib_hospital_author_hide',true) != '') { ?>
				<div class="post-info py-1 px-2 mb-2">
					...
					<?php if( get_theme_mod( 'tabib_hospital_comment_hide',true) != '') { ?>
				  		<i class="<?php echo esc_attr(get_theme_mod('tabib_hospital_post_comment_icon_changer','fas fa-comments'));?> ps-2 pe-2"></i><span class="entry-comments ps-2 pe-2"><?php comments_number( __('0 Comments','tabib-hospital'), __('0 Comments','tabib-hospital'), __('% Comments','tabib-hospital') ); ?></span>
					<?php } ?>
				</div>
			<?php }?>
