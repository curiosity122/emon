            ...
            <div class="carousel-caption">
              <div class="inner_carousel">
                ...
                <?php if( get_theme_mod('tabib_hospital_slider_content',true) != ''){ ?>
                  <p><?php $excerpt = get_the_excerpt(); echo esc_html( tabib_hospital_string_limit_words( $excerpt, esc_attr(get_theme_mod('tabib_hospital_slider_excerpt_number','35')))); ?></p>
                <?php } ?>
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="<?php if(has_post_thumbnail()) { ?>col-lg-8 col-md-8"<?php } else { ?>col-lg-12 col-md-12" <?php } ?>>
                        <div class="service-box">
                          ...
                          <p><?php $excerpt = get_the_excerpt(); echo esc_html( tabib_hospital_string_limit_words( $excerpt,10 ) ); ?></p>
                        </div>
                      </div>
                    </div>
                  </div>
